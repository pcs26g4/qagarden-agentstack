...
def test_page_2_complete_web_form_elements_visible(page):
    page.goto(PAGE_2_F871_URL, timeout=60000)
    page.wait_for_load_state('networkidle')
...
@pytest.mark.regression
def test_page_2_complete_web_form_fill_and_submit(page):
    page.goto(PAGE_2_F871_URL, timeout=60000)
    page.wait_for_load_state('networkidle')
    page.locator("xpath=//a[contains(text(), ").click()
...
@pytest.mark.regression
def test_page_2_navigation_to_buttons(page):
    page.goto(PAGE_2_F871_URL, timeout=60000)
    page.wait_for_load_state('networkidle')

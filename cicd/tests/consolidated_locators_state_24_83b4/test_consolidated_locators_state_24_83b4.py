...
from config.urls import CONSOLIDATED_LOCATORS_STATE_24_83B4_URL
from playwright.sync_api import expect
import re

def test_TC_Navigation_001(page):
    page.goto(CONSOLIDATED_LOCATORS_STATE_24_83B4_URL, timeout=60000)
...
def test_TC_Pagination_002(page):
    ...
    expect(page).to_have_url(re.compile(r"/pages/forms/\?page_num=14"))
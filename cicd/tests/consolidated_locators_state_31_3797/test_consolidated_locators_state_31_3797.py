...
def test_TC_Navigation_01(page):
    page.goto(CONSOLIDATED_LOCATORS_STATE_31_3797_URL, timeout=60000)
    page.wait_for_load_state('networkidle')
    page.locator('a.nav-link').nth(0).click()
    expect(page).to_have_url(re.compile(r"/lessons/"), timeout=15000)
...
def test_TC_Pagination_01(page):
    ...
    expect(page).to_have_url(re.compile(r"/pages/forms/\?page_num=5"), timeout=15000)

...
from config.urls import CONSOLIDATED_LOCATORS_STATE_28_43E2_URL
from playwright.sync_api import expect
import re
import pytest

def test_TC_Navigation_01(page):
    page.goto(CONSOLIDATED_LOCATORS_STATE_28_43E2_URL, timeout=60000)
...
def test_TC_Search_01(page):
    page.goto(CONSOLIDATED_LOCATORS_STATE_28_43E2_URL, timeout=60000)
    page.wait_for_load_state('networkidle')
    page.locator('#q').first.fill("Montreal Canadiens")
